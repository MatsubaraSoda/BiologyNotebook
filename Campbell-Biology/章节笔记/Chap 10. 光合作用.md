...
graph TB
    subgraph "光反应 - Z机制"
        ...
        subgraph "光系统I (PSI)"
            ...
            NADP_to_NADPH -->|在基质中| NADPH_out[NADPH → 卡尔文-本森循环]
        end
        ...
        subgraph "ATP合成"
            ...
            ATP_synthesis -->|在基质中| ATP_out[ATP → 卡尔文-本森循环]
        end
...
[RuBP](../思考/卡尔文-本森循环分子结构示意图.md#rubp) (5C) + [CO₂](../思考/卡尔文-本森循环分子结构示意图.md#co2) → 2 × [3-PGA](../思考/卡尔文-本森循环分子结构示意图.md#3pga) (3C)

**阶段二：还原**

步骤一：磷酸化

[3-PGA](../思考/卡尔文-本森循环分子结构示意图.md#3pga) + [ATP](../思考/卡尔文-本森循环分子结构示意图.md#atp) → [1,3-BPG](../思考/卡尔文-本森循环分子结构示意图.md#13bpg) + [ADP](../思考/卡尔文-本森循环分子结构示意图.md#adp)

步骤二：还原

[1,3-BPG](../思考/卡尔文-本森循环分子结构示意图.md#13bpg) + [NADPH](../思考/卡尔文-本森循环分子结构示意图.md#nadph) + H⁺ → [G3P](../思考/卡尔文-本森循环分子结构示意图.md#g3p) + [NADP⁺](../思考/卡尔文-本森循环分子结构示意图.md#nadp) + [Pi](../思考/卡尔文-本森循环分子结构示意图.md#pi)

**阶段三：RuBP 再生**

5 [G3P](../思考/卡尔文-本森循环分子结构示意图.md#g3p) (15C) + 3 [ATP](../思考/卡尔文-本森循环分子结构示意图.md#atp) → 3 [RuBP](../思考/卡尔文-本森循环分子结构示意图.md#rubp) (15C) + 3 [ADP](../思考/卡尔文-本森循环分子结构示意图.md#adp) + 3 [Pi](../思考/卡尔文-本森循环分子结构示意图.md#pi)
...
[卡尔文-本森循环分子结构示意图](../思考/卡尔文-本森循环分子结构示意图.md) — 循环中各中间物的分子结构与命名。
